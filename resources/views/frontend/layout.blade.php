...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/frontend/lib/bootstrap/css/bootstrap.min.css" />
    <link rel="stylesheet" type="text/css" href="/frontend/lib/font-awesome/css/font-awesome.min.css" />
    <link rel="stylesheet" type="text/css" href="/frontend/lib/select2/css/select2.min.css" />
    <link rel="stylesheet" type="text/css" href="/frontend/lib/jquery.bxslider/jquery.bxslider.css" />
    <link rel="stylesheet" type="text/css" href="/frontend/lib/owl.carousel/owl.carousel.css" />
    <link rel="stylesheet" type="text/css" href="/frontend/lib/jquery-ui/jquery-ui.css" />
    ...
    <link href="{{ asset('/common/fonts/styles.css') }}" rel="stylesheet" type="text/css"> @stack('css')
...
======================================-->
    ...
    <!-- Script-->
    <script type="text/javascript" src="/frontend/lib/jquery/jquery-1.11.2.min.js"></script>
    <script type="text/javascript" src="/frontend/lib/bootstrap/js/bootstrap.min.js"></script>
    <script type="text/javascript" src="/frontend/lib/select2/js/select2.min.js"></script>
