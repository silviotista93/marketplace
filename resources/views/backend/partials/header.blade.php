    ...
    <div class="br-header-right">
        <nav class="nav">
            ...
            <div class="dropdown">
                ...
                <img src="{{ auth()->user()->picture}}" class="wd-32 rounded-circle" alt="" 
                style="
                ...
                <div class="dropdown-menu dropdown-menu-header wd-250">
                    <div class="tx-center">
                        <a href=""><img src="{{ auth()->user()->picture}}" class="wd-80 rounded-circle" alt="" 
                        style="
                            vertical-align: middle;
                            width: 100px;
                            height: 100px;
                            border-radius: 50%" ></a>
                        <h6 class="logged-fullname">{{auth()->user()->name}} {{auth()->user()->last_name}}</h6>
                        <p>{{auth()->user()->email}}</p>
                    </div>
                    {{-- <hr>
                    <div class="tx-center">
